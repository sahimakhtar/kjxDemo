    ...
    const data = [
        {
            ...
            discrp:"We, at Kjxsoftech, believe that now is the perfect time to be productive and that is why we offer flexible working hours to give our team a comfortable yet productive zone.",
            image: img
        },
        {
            id:2,
            title:"Special Leave",
            discrp:"This is something on which we can flex! Kjxsoftech understands how important career growth is and hence we assure positive career growth.",
            image: img1
        },
        {
            id:3,
