                        ...
                        {/* <div class="grid grid-rows-3 grid-flow-col gap-4"> */}
                            <div class="row-span-2">
                                ...
                                <div className=" border-slate-400 border-solid border px-8 mx-8  bg-slate-300 text-center p-6 shadow-md">
                                    <h1 className="font-semibold">Fast service</h1>
                            ...
                            <div class="row-span-2">
                                <div className=" border-slate-400 border-solid border bg-auto bg-no-repeat bg-center shadow-md">
                                    <img className="bg-cover h-80 transform transition duration-500 hover:scale-110" src={pocketFriendly} alt="" />
                                </div>
                                <div className=" border-slate-400 border-solid border px-8 mx-8 bg-slate-300 text-center p-6 shadow-md">
                                    <h1 className="font-semibold">Pocket-friendly</h1>
                            ...
                            <div class="row-span-2">
                                ...
                                <div className=" border-slate-400 border-solid border px-8 mx-8 bg-slate-300 text-center p-6 shadow-md">
                                    <h1 className="font-semibold">Global Enterprise Development</h1>
