                        ...
                        <div class="grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-4 xl:grid-cols-4 xl:gap-x-8">
                            <Hold >
                                <Card className="group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={AI_img} />
                                    <span className="text-slate-900 group-hover:text-white">Machine Learning/AI</span>
                                </Card>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={IOT} />
                                    <span className="text-slate-900 group-hover:text-white">IOT & Cloud Services</span>
                                </Card>
                            </Hold>
                            <Hold>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={enterprise} />
                                    <span className="text-slate-900 group-hover:text-white">Solution & ERP Design</span>
                                </Card>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={devops} />
                                    <span className="text-slate-900 group-hover:text-white">Devops</span>
                                </Card>
                            </Hold>
                            <Hold>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={UIUX} />
                                    <span className="text-slate-900 group-hover:text-white">UI/UX Development</span>
                                </Card>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={operation} />
                                    <span className="text-slate-900 group-hover:text-white">Custom Software Development</span>
                                </Card>
                            </Hold>
                            <Hold>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={dataVisualization} />
                                    <span className="text-slate-900 group-hover:text-white">Data Visualization</span>
                                </Card>
                                <Card className=" group  bg-white ring-1 ring-slate-900/5 shadow-lg  hover:bg-sky-500 hover:ring-sky-500">
                                    <img src={ecommerce} />
                                    <span className="text-slate-900 group-hover:text-white">E-commerce Development</span>
                                </Card>
                            </Hold>
                        </div>
